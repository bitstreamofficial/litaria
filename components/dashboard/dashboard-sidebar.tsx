...
export function DashboardSidebar() {
  ...
  return (
    <aside className="w-56 bg-white shadow-sm border-r fixed left-0 top-0 h-screen flex flex-col shrink-0 z-10">
      <nav className="pt-8 px-4 pb-4 flex-1 overflow-y-auto">
